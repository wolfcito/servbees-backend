...
*/
  ...
  stages{
    ...
    stage('Static Code Analysis') {
       steps{
        	sonarqubeMasQualityGatesP(sonarKey:'co.com.ceiba.adn:servbees-backend-luis.ushina', 
    ...
    stage('Build') {
      steps {
        echo "------------>Build<------------"
        sh './servbees-usuario/gradlew --b ./servbees-usuario/build.gradle build -x test'
      }
    }  
  }
