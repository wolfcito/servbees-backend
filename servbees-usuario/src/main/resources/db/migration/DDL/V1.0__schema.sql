...
CREATE TABLE servicio_proporcionado (
 ...
 modalidad varchar(2) not null CHECK(modalidad IN('ph', 'pd', 'ps')), -- ph: por hora, pd: por dia, ps: por semana
 cantidad int null default(0),
 costo number(9,2) not null,
 nivel_satisfacion varchar(3) not null CHECK(nivel_satisfacion IN('sup', 'inf', 'nor')), -- sup: superior, inf: inferior, nor: normal
...
-- DATA SERVICIO
--insert into servicio_proporcionado(id, id_categoria, id_usuario_cli, id_usuario_pro, nivel_satisfacion, modalidad, is_activo, costo, fecha) values(1, 1, 2, 1, 'sup', 'ph', 1, 100, now());
--insert into servicio_proporcionado(id, id_categoria, id_usuario_cli, id_usuario_pro, nivel_satisfacion, modalidad, is_activo, costo, fecha) values(2, 1, null, 1, 'sup', 'ph', 0, 100, now());
--insert into servicio_proporcionado(id, id_categoria, id_usuario_cli, id_usuario_pro, nivel_satisfacion, modalidad, is_activo, costo, fecha) values(3, 1, 2, 1, 'sup', 'ph', 1, 100, now());
