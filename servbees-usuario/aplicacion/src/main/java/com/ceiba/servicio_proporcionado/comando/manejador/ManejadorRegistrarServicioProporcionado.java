...
@Component
public class ManejadorRegistrarServicioProporcionado implements ManejadorComandoRespuesta<ComandoRegistrar, ComandoRespuesta<Long>> {
    ...
    public ManejadorRegistrarServicioProporcionado(FabricaServicioProporcionado fabricaServicioProporcionado, ServicioRegistrarServicioProporcionado servicioRegistrarServicioProporcionado) {
